const { admin, db } = require("../firebase-admin.js");
const { registerSchema } = require("../middlewares/requestHandler.js");
const { getName, getUser } = require("../utils/getUser.js");
...
function AuthenticateAndSendData(req, res) {
  try {
